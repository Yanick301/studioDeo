            ...
            >
              <CarouselContent>
                {categories.map((category) => {
                  ...
                  const categoryName = dictionary.categories[category.slug as keyof typeof dictionary.categories] || category.name;
                  return (
                          ...
                          <Card className="overflow-hidden group">
                            <CardContent className="p-0 relative aspect-[4/3]">
                              ...
                              <div className="absolute inset-0 flex items-center justify-center">
                                <h3 className="text-2xl font-headline font-bold text-white">{categoryName}</h3>
                              </div>
                            </CardContent>
                          </Card>
                        </Link>
